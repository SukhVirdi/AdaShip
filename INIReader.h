...
public:
    ...
    const int GetNumberOfFields(std::string section) const;
...
inline const std::set<std::string> INIReader::GetFields(std::string section) const
{
...
inline const int INIReader::GetNumberOfFields(std::string section) const
{
